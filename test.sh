...
echo -e "${YELLOW}[2/9] 测试场景 1: 默认行为（生成 .min.html）${NC}"
...
echo -e "${YELLOW}[3/9] 测试场景 2: 自定义后缀${NC}"
...
echo -e "${YELLOW}[4/9] 测试场景 3: 指定输出文件（不添加后缀）${NC}"
...
echo -e "${YELLOW}[5/9] 测试场景 4: 文件夹压缩（默认后缀 min）${NC}"
...
echo -e "${YELLOW}[6/9] 测试场景 5: 文件夹输出到指定目录（不添加后缀）${NC}"
...
echo -e "${YELLOW}[7/9] 测试场景 6: 文件夹输出到指定目录并添加后缀${NC}"
...
echo -e "${YELLOW}[8/9] 测试场景 7: 验证压缩效果${NC}"
